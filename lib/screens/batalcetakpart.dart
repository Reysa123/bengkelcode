...
class Batalcetakpart extends StatefulWidget {
  const Batalcetakpart({super.key});

  @override
  State<Batalcetakpart> createState() => _BatalcetakpartState();
}

class _BatalcetakpartState extends State<Batalcetakpart> {
